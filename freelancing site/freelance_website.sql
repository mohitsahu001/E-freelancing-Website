...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2022 at 06:01 PM
...
(10, 1, 'Salesforce defect fix', 'Users are able to access community through deep links even though they don’t have access to that community through log in. Need to implement a fix for this. Has to connect through zoom and work on this', 30, 250, '2022-10-21', 3, '', NULL),
...
(22, 12, 'App development', 'lorem ipsum', 193, 293, '2022-12-15', 7, '4637861_Business card.zip', 'php, js, html');
...
(2, 'vivek', 'vivekkmr2223@gmail.com', '$2y$10$JbHqv3EF6VZPqjKWjnV3lOhkUrDwsschEYWf1igbeLW/tzDlMKi7y', 'Dec 09, 2022'),
...
(23, 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 'unknown.jpg'),
...
--
ALTER TABLE `apply_for_job`
  MODIFY `afjid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `experience_details`
--
ALTER TABLE `experience_details`
  MODIFY `uexid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `hire_notification`
--
ALTER TABLE `hire_notification`
  MODIFY `hnid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `upload_completed_job`
  MODIFY `ucjid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `user_profile_details`
  MODIFY `upid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `user_qualification_details`
--
ALTER TABLE `user_qualification_details`
  MODIFY `uqid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `user_skills`
--
ALTER TABLE `user_skills`
  MODIFY `user_skill_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
COMMIT;
